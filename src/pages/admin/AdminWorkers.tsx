...
import { Search, Plus, Edit, Trash2, CheckCircle, XCircle, Eye } from "lucide-react";
...
const AdminWorkers = () => {
  ...
  return (
    <AdminLayout title="Kelola Pekerja">
              ...
              <TableRow key={worker.id}>
                ...
                <TableCell>
                  <div className="flex gap-2">
                    ...
                    {worker.isAvailable ? (
                      <Badge className="bg-accent/10 text-accent-foreground border-accent/20">Tersedia</Badge>
                    ) : (

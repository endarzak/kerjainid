...
const AdminSettings = () => {
  ...
  const handleResetData = () => {
    ...
    localStorage.removeItem("cms_skills");
    localStorage.removeItem("cms_faq");
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {((localStorage.getItem("cms_workers")?.length || 0) / 1024).toFixed(2)} KB
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Data Employer</span>
                    <span className="font-medium">
                      {((localStorage.getItem("cms_employers")?.length || 0) / 1024).toFixed(2)} KB
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Data Lowongan</span>
                    <span className="font-medium">
                      {((localStorage.getItem("cms_jobs")?.length || 0) / 1024).toFixed(2)} KB
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Data Artikel</span>
                    <span className="font-medium">
                      {((localStorage.getItem("cms_articles")?.length || 0) / 1024).toFixed(2)} KB
                    </span>
                  </div>
                </div>
              </CardContent>
